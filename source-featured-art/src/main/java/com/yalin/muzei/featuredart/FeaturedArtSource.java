package com.yalin.muzei.featuredart;
...
import com.yalin.muzei.api.RemoteMuzeiArtSource;
...
public class FeaturedArtSource extends RemoteMuzeiArtSource {
    ...
    protected void onUpdate(int reason) {
        ...
        commands.add(new UserCommand(COMMAND_ID_SHARE,
                getString(R.string.featuredart_action_share_artwork)));
    ...
    protected void onTryUpdate(int reason) throws RetryException {
        ...
        Date nextTime = null;
        String nextTimeStr = jsonObject == null ? null : jsonObject.optString("nextTime");
