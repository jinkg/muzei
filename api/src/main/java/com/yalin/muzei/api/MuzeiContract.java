...
public class MuzeiContract {
    ...
    public static final String AUTHORITY = "com.yalin.muzei";
     ...
     * {@link com.yalin.muzei.api.Artwork Artwork} object. The helper method
     ...
     * use {@link com.yalin.muzei.api.Artwork#fromCursor(android.database.Cursor) Artwork.fromCursor(Cursor)}
    ...
    public static final class Artwork implements BaseColumns {
         ...
         */
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.yalin.muzei.artwork";
        /**
         * The MIME type of {@link #CONTENT_URI} providing a single piece of artwork.
         */
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.yalin.muzei.artwork";
        /**
         ...
         * artwork.
         */
        public static final String ACTION_ARTWORK_CHANGED = "com.yalin.muzei.ACTION_ARTWORK_CHANGED";

        /**
         * Returns the current Muzei {@link com.yalin.muzei.api.Artwork Artwork}
         *
         * @param context Context to retrieve a ContentResolver
         * @return the current Artwork or null if one could not be found
         */
        public static com.yalin.muzei.api.Artwork getCurrentArtwork(Context context) {
            ...
            try {
                ...
                return com.yalin.muzei.api.Artwork.fromCursor(cursor);
            } finally {
                cursor.close();
            }
        }
    ...
    public static final class Sources implements BaseColumns {
         ...
         * source info.
         */
        public static final String ACTION_SOURCE_CHANGED = "com.yalin.muzei.ACTION_SOURCE_CHANGED";
